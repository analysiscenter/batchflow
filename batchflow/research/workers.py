...
class PipelineWorker(Worker):
    ...
    def init(self):
        ...
        all_devices = [device for i in range(n_branches) for device in self.devices[i]['device'] if device is not None]
        ...
        mapping = {
            item: 'gpu:' + str(i) for i, item in enumerate(set(all_devices))
        }
