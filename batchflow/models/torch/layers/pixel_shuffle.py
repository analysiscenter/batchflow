...
class PixelShuffle(nn.Module):
    """ Rearranges elements in a tensor of shape [B, C * r^N, D1, D2, ... DN] to a tensor of shape [B, C, D1 * r, D2 * r, ... DN * r]
...
class PixelUnshuffle(nn.Module):
    """ Reverses `PixelShuffle` operation by rearranging elements in a tensor of shape [B, C, D1 * r, D2 * r, ... DN * r]
