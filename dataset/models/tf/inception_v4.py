   ...
   """
    ...
    def inception_b_block(cls, inputs, filters, layout='cna', name='inception_b_block', **kwargs):
        ...
        with tf.variable_scope(name):
            ...
            branch_1_7 = conv_block(inputs, layout*3, [filters[1], filters[2], filters[3]], kernel_size, name='conv_1_7', **kwargs)

            kernel_size = [1, *factor*2]
            branch_1_7_7 = conv_block(inputs, layout*5, [filters[1]]*2+[filters[2]]*2+[filters[3]], kernel_size, name='conv_1_7_7', **kwargs)
    ...
    def reduction_grid_block(cls, inputs, filters, layout='cna', name='reduction_b_block', **kwargs):
        ...
        with tf.variable_scope(name):
            branch_1 = conv_block(inputs, layout, filters[0], 1, name='conv_1', **kwargs)
            branch_1_3 = conv_block(branch_1, layout, filters[0], 3, name='conv_1_3', strides=2, padding='valid', **kwargs)

            branch_1_7 = conv_block(inputs, layout*3, [filters[1]]*2+[filters[2]], [1, [1, 7], [7, 1]], name='conv_1_7', **kwargs)
            branch_1_7_3 = conv_block(branch_1_7, layout, filters[2], 3, name='conv_1_7_3', strides=2, padding='valid', **kwargs)

            branch_pool = conv_block(inputs, layout='p', name='max_pooling', pool_size=3, pool_strides=2, padding='valid', **kwargs)
    ...
    def inception_c_block(cls, inputs, filters, layout='cna', name='inception_c_block', **kwargs):
        ...
        with tf.variable_scope(name):
            ...
            branch_1_13_31 = conv_block(inputs, layout*3, [filters[1], filters[2], filters[3]], [1, [1, 3], [3, 1]], name='conv_1_13_31', **kwargs)
